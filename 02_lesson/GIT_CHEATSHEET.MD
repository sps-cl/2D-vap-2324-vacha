...
Pokud máte někdo chuť, forkněte toto repo, přeložte tento materiál a udělejte pull request. :) 
...
`git help <command>` - Zobrazit nápovědu specifického příkazu
...
`git commit --amend` - Změň poslední commit. *Don‘t amend published commits!!*
